...
/***/ function(module, exports) {
	...
	var init = function () {
	    ...
	    var state = void 0;
	    var auth_containers = void 0;
	    var auth_components = void 0;
	    var post_containers = void 0;
	    var post_components = void 0;
	    ...
	    //function
	    var authentificate = void 0;
	    var loadPostList = void 0;
	    var showTheData = void 0;
	    var makePost = void 0;

	    authentificate = function authentificate() {
	        $.get('/auth', function (username) {
	            if (!username) {
	    ...
	    showTheData = function showTheData(post) {
	    ...
	    makePost = function makePost(post) {
	        ...
	        new_li.onclick = function () {
	            $.get('get/' + new_li.id, function (post) {
	                showTheData(post);
	            });
	        };
	    ...
	    post_components.post_write_content.addEventListener('keyup', function (e) {
	        if (e.keyCode == 13) {
	            post_components.post_write_save.onclick();
	        }
	    });
	    auth_components.auth_password.addEventListener('keypress', function (e) {
	        if (e.keyCode == 13) {
	            e.preventDefault();auth_components.auth_ok.onclick();
	        }
	    });

	    authentificate();

	    auth_components.auth_login.onclick = function () {
	        state.current = 'login';
	    ...
	    auth_components.auth_signup.onclick = function () {
	        state.current = 'signup';
	        auth_containers.auth_id_and_password.style.display = 'block';
	        auth_containers.auth_ok_and_no.style.display = 'block';
	        auth_containers.auth_login_and_signup.style.display = 'none';
	    };
	    auth_components.auth_ok.onclick = function () {
	        ...
	        if (state.current === 'login') {
	            $.post('login', username_and_password, function (err) {
	                if (err !== 'success') {
	            ...
	            $.post('signup', username_and_password, function (err) {
	                if (err !== 'success') {
	                    auth_components.auth_message.innerHTML = err;
	                    auth_components.auth_message.style.visibility = 'visible';
	                    setTimeout(function () {
	    ...
	    auth_components.auth_no.onclick = function () {
	        state.current = 'default';
	        auth_containers.auth_id_and_password.style.display = 'none';
	    ...
	    auth_components.auth_logout.onclick = function () {
	        $.get('logout', function () {
	            window.location.reload(true);
	        });
	    };
	    auth_components.auth_delete.onclick = function () {
	        $.post('account/delete', { 'username': state.username }, function () {
	            window.location.reload(true);
	        });
	    };
	    post_components.post_delete.onclick = function () {
	        $.post('delete', { _id: state.post_id }, function (post) {
	    ...
	    auth_components.auth_user.onclick = function () {
	        if (auth_containers.auth_logout_and_remove.style.display === 'block') auth_containers.auth_logout_and_remove.style.display = 'none';else auth_containers.auth_logout_and_remove.style.display = 'block';
	    };
	    post_components.post_modify.onclick = function () {
	        post_components.post_modify.style.display = 'none';
	        state.current = 'modify';
	        $.get('get/' + state.post_id, function (post) {
	    ...
	    post_components.post_write_save.onclick = function () {
	        var write_title_value = post_components.post_write_title.value;
	        var write_content_value = post_components.post_write_content.value;
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "body {\r\n    margin:0px;\r\n}\r\n* {\r\n    box-sizing: border-box;\r\n}\r\n.post {\r\n    float: left;\r\n    padding: 15px;\r\n    width: 50%;\r\n}\r\n.auth {\r\n    text-align: center;\r\n    padding:30px\r\n}\r\ntextarea{\r\n    width:100%;\r\n    resize: none;\r\n}\r\nli {\r\n    list-style: none;\r\n}\r\nli:hover {\r\n    cursor:pointer;\r\n    color:blue;\r\n}\r\n.li_mine {\r\n    color:red;\r\n}\r\n.auth_inputs{\r\n    width:100px;\r\n    height:20px;\r\n}\r\n#auth_login_and_signup, #auth_ok_and_no, #auth_id_and_password, #auth_logout_and_remove, #post_delete, #post_modify,\r\n#post_write{\r\n    display: none;\r\n}\r\n\r\n#auth_message {\r\n    visibility: hidden;\r\n    color: red;\r\n}\r\n\r\n#auth_user:hover {\r\n    cursor: pointer;\r\n    color:red;\r\n}\r\n\r\n#post_title{\r\n\r\n}\r\n\r\n.draggable {\r\n\r\n    -webkit-transform: translate(0px, 0px);\r\n    transform: translate(0px, 0px);\r\n    -ms-touch-action: none;\r\n    touch-action: none;\r\n}", ""]);
